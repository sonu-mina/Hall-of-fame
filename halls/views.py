...
def home(request):
    ...
    popular_halls = [Hall.objects.get(pk = 5),Hall.objects.get(pk = 3),Hall.objects.get(pk = 4)]
...
def video_search(request):
    ...
    if search_form.is_valid():
        ...
        response = requests.get(f'https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=7&q={encoded_search_term }&key={YOUTUBE_API_KEY}')
        print('jsonnnn',response.json())
